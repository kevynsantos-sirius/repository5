...
public class ChecklistServiceAPI {
    ...
    public ChecklistServiceAPI(ChecklistRepository checklistRepository,
                            LayoutRepository layoutRepository,
                            MassaDadoRepository arquivoRepository, 
    ...
    public ChecklistDTO criar(ChecklistDTO dto,
...
//                            massa.setViaTxt(layoutDTO.isViaTxt());
    ...
    public Checklist getDocumentoById(Integer id) {
    	...
    	checkList = checklistRepository.findById(id).orElseThrow(() -> new RuntimeException("Documento não localizado id " + id)); 
